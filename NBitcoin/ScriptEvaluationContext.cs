...
#nullable enable
	public class TransactionChecker
	{
		...
		public bool CheckSchnorrSignature(byte[] sig, byte[] pubkey_in, HashVersion taproot, ExecutionData executionData, out ScriptError err)
		{
			...
			var hash = this.Transaction.GetSignatureHashTaproot(TaprootReadyPrecomputedTransactionData(Transaction), new TaprootExecutionData(this.Index, executionData.TapleafHash)
			{
